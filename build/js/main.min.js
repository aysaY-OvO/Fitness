...
var _iosVhFix = require("./utils/ios-vh-fix.js");
var _form = require("./modules/form-validate/form.js");
var _initTabs = require("./modules/tabs/init-tabs.js");
// ---------------------------------
var playVideo = document.querySelector('[data-button="play-video"]');
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    playVideo.addEventListener('click', function (evt) {
...
},{"./modules/form-validate/form.js":3,"./modules/tabs/init-tabs.js":9,"./utils/ios-vh-fix.js":12}],2:[function(require,module,exports){
"use strict";
...
var _callback = require("./callback.js");
var _initPhoneInput = require("./init-phone-input.js");
...
},{"./callback.js":2,"./init-phone-input.js":4,"./validator.js":8}],4:[function(require,module,exports){
"use strict";
...
var _regularExpression = require("./regular-expression.js");
var _matrix = require("./matrix.js");
var _renderMessage2 = require("./render-message.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
},{"./matrix.js":5,"./regular-expression.js":6,"./render-message.js":7}],9:[function(require,module,exports){
"use strict";
...
},{"./tabs.js":10}],10:[function(require,module,exports){
"use strict";
...
var _iosChecker = require("./ios-checker.js");
